...
public enum EventType implements Serializable {
        ...
        BRIEFING ("Briefing control", 1L,"KA_EVENT_CONTROL_BRIEFING"),
        PRE_SCRUTINEERING ("Pre-Scrutineering", 2L, ""),
        PRACTICE_TRACK ("Practice Track control", 3L, ""),
        SKIDPAD ("Skidpad control", 4L, ""),
        ACCELERATION ("Acceleration control", 10013L, "KA_EVENT_CONTROL_ACCELERATION"),
        AUTOCROSS ("Autocross control", 6L, ""),
        ENDURANCE_EFFICIENCY ("Endurance control", 10015L, "KA_EVENT_CONTROL_ENDURANCE");

package code.formulastudentspain.app.mvp.view.screen.teammember.recyclerview;
...
public class TeamMemberListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mLayoutInflater.inflate(R.layout.fragment_team_member_list_item, parent, false);

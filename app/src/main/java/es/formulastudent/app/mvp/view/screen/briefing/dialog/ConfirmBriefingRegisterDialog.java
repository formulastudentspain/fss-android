package es.formulastudent.app.mvp.view.screen.briefing.dialog;
...
public class ConfirmBriefingRegisterDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(rootView)
            ...
            .setPositiveButton(R.string.briefing_activity_dialog_confirm_button_confirm, (dialog, id) -> presenter.createRegistry(teamMember))
            .setNegativeButton(R.string.briefing_activity_dialog_confirm_button_cancel, (dialog, id) -> ConfirmBriefingRegisterDialog.this.getDialog().cancel());
